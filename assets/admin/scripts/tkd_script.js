...
var FormScript = function () {
    ...
    var handleDateTimePicker = function () {
    if($(".ddefault-date-picker").length > 0)
        $(".ddefault-date-picker").datepicker({format: 'm/d/Y g:i A'});
    if($(".default-datetime-picker").length > 0)
        $(".default-datetime-picker").datetimepicker({format: 'm/d/Y g:i A'});
    ...
    if($(".default-datetime-picker1").length > 0)
        $(".default-datetime-picker1").datetimepicker({format: 'm/d/Y g:i A'});
}
