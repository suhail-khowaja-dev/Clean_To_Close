...
class Model_signup extends MY_Model
{
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "signup_id,signup_name,signup_lastname, signup_email,signup_contact,signup_createdon,signup_status";
        $this->pagination_params['where_string'] = "signup_type ="."1";
        // Call the Model constructor
        parent::__construct();
    ...
    public function get_fields($specific_field = "")
    {
        ...
        $data =  array(
            ...
            'signup_password_show' => array(
                'table' => $this->_table,
                'name' => 'signup_password_show',
                'label' => 'Password',
                'type' => 'text',
                'attributes' => array(),
                'js_rules' => '',
            ...
            // 'signup_avail_job' => array(
            //     'table' => $this->_table,
            //     'name' => 'signup_avail_job',
            //     'label' => 'avail job',
            //     'type' => 'hidden',
            //     'attributes' => array(),
            //     'js_rules' => '',
            ...
            'signup_insurance_company_image' => array(
                ...
                'preview' => 'true',
                'attributes'   => array(
                    'allow_ext'=>'doc|dox|pdf|png|jpeg|jpg',
                ),
            ...
            'signup_status'=> array(
                ...
                'list_data' => array(
                   ...
                   3 => "<span class='label label-primary suspended'>Suspended</span>",
               ) ,
                'default' => '1',
                'attributes' => array(),
                'dt_attributes' => array("width" => "7%"),
            ...
            'signup_package_total_amount' => array(
                'table' => $this->_table,
                'name' => 'signup_package_total_amount',
                'label' => 'Packag Total Amount',
                'type' => (!empty($is_required_image)?'text':'hidden'),
                'attributes' => array(),
                'js_rules' => '',
                'rules' => 'strtolower|trim|htmlentities'
            ),
            'signup_job_opportunities' => array(
                'table' => $this->_table,
                'name' => 'signup_job_opportunities',
            ...
            'signup_package_amount' => array(
                'table' => $this->_table,
                'name' => 'signup_package_amount',
            ...
            'signup_status_suspended'=> array(
                    'table' => $this->_table,
                    'name' => 'signup_status_suspended',
                    'label' => 'Status',
                    'type' => 'switch',
                    'type_dt' => 'switch',
                    'type_filter_dt' => 'dropdown',
