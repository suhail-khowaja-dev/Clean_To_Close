...
class Model_cms_page extends MY_Model
{
    ...
    */
    public function get_fields($specific_field = "")
    {
        ...
        if ($this->uri->segment(4) != 2 && $this->uri->segment(4) != 3 && $this->uri->segment(4) != 4 && $this->uri->segment(4) != 5 && $this->uri->segment(4) != 6 && $this->uri->segment(4) != 7 && $this->uri->segment(4) != 8 && $this->uri->segment(4) != 1) {
        ...
        if (($this->uri->segment(4) == 1)  || ($this->uri->segment(4) ==2) || ($this->uri->segment(4) ==3) || ($this->uri->segment(4) ==4) || ($this->uri->segment(4) ==6) || ($this->uri->segment(4) ==7) || ($this->uri->segment(4) ==8)) {
        ...
        //     );
        // }
        if ($this->uri->segment(4) == 24) { 
        $fields['cms_page_video_url'] = array(
            'table' => $this->_table,
            'name' => 'cms_page_video_url',
            'label' => 'Youtube URL 
            <br> <span style=color:red!important;">(Use Only Embed Url)</span>',
            'type' => 'text',
            'attributes'   => array(),
            'js_rules' => '',
