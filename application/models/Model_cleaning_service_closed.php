<?
class Model_cleaning_service_closed extends MY_Model {
    /**
    ...
    function __construct()
    {
        ...
        $this->pagination_params['where_string'] = "cleaning_service_compelted_user_id != '0' and cleaning_service_status ='5'";
        parent::__construct();
        ...
        $fields = array(
            ...
            'cleaning_service_status' => array(
                ...
                'list_data' => array(
                    ...
                    // 3 =>  "<span class='label label-primary'>Accpted</span>",
                    // 4 =>  "<span class='label label-primary'>Submitting</span>",
                    5 =>  "<span class='label label-primary'>Closed</span>"
