...
class Model_signup_cleaner extends MY_Model
{
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "signup_id, signup_name, signup_lastname,signup_email, signup_contact,signup_zip,signup_createdon,signup_job_opportunities,signup_status";
        $this->pagination_params['where_string'] = "signup_type = '2' and signup_status !='0'";
        // $this->pagination_params['where_string'] = "signup_type ="."2";
        // $this->pagination_params['where_string'] = "signup_status ="."1" ;
