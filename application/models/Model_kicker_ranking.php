...
class Model_kicker_ranking extends MY_Model
{
    ...
    function __construct()
    {
      ...
      $this->pagination_params['fields'] = "kicker_ranking_id,kicker_ranking_year,kicker_ranking_title,kicker_ranking_state,kicker_ranking_offers,kicker_ranking_status";
    ...
    */
    public function get_fields($specific_field = "")
    {
      ...
      $fields = array(
       ...
       // 'kicker_ranking_graduation_year' => array(
       //   'table'   => $this->_table,
       //   'name'   => 'kicker_ranking_graduation_year',
       //   'label'   => 'Graduation Year',
       //   'type'   => 'dropdown',
       //   'list_data'    => array(
       //    "1990"=>"1990",
       ...
       // ),
              ...
              // 'kicker_ranking_slug'  => array(
              //     'table'   => $this->_table,
              //     'name'   => 'kicker_ranking_slug',
              //     'label'   => 'Slug',
              //     'type'   => 'text',
              //     'attributes'   => array(),
        ...
        'kicker_ranking_prospect' => array(
         ...
         'rules'   => '',
          ...
          //   'kicker_ranking_short_detail' => array(
          //       'table' => $this->_table,
          //       'name' => 'kicker_ranking_short_detail',
          ...
          // 'kicker_ranking_detail' => array(
          //       'table' => $this->_table,
          //       'name' => 'kicker_ranking_detail',
          ...
          //   'kicker_ranking_image' => array(
          //       'table' => $this->_table,
          //       'name' => 'kicker_ranking_image',
          //       'label' => 'Image',
          //       'name_path' => 'kicker_ranking_image_path',
          //       'upload_config' => 'site_upload_kicker_ranking',
          //       'type' => 'fileupload',
          //       'type_dt' => 'image',
          //       'randomize' => true,
          //       'preview' => 'true',
          //       // 'thumb'   => array(array('name'=>'kicker_ranking_image_thumb','max_width'=>470, 'max_height'=>316),),
          //       'attributes'   => array(
          ...
          //   ),
            // 'kicker_ranking_image_detail1' => array(
            //     'table' => $this->_table,
            //     'name' => 'kicker_ranking_image_detail1',
            ...
            //    // 'js_rules'=>$is_required_image
            // ),
            // 'kicker_ranking_image_detail2' => array(
            //     'table' => $this->_table,
            //     'name' => 'kicker_ranking_image_detail2',
            ...
            //    // 'js_rules'=>$is_required_image
            // ),
            // 'kicker_ranking_image_detail12' => array(
            //     'table' => $this->_table,
            //     'name' => 'kicker_ranking_image_detail12',
         ...
         /*'kicker_ranking_by' => array(
                'table' => $this->_table,
                'name' => 'kicker_ranking_by',
                'label' => 'By',
                'type' => 'text',
                'attributes' => array(),
                'js_rules' => 'required',
     ...
     // 'kicker_ranking_latest_featured' => array(
     //            'table' => $this->_table,
     //            'name' => 'kicker_ranking_latest_featured',
     //            'label' => 'Is Featured?',
     //            'type' => 'switch',
     //            'type_dt' => 'dropdown',
     //            'type_filter_dt' => 'dropdown',
     //            'list_data_key' => "kicker_ranking_latest_featured" ,
     //            'list_data' => array(),
     //            'default' => '0',
     //            'attributes' => array(),
