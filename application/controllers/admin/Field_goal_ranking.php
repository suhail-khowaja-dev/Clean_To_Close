...
class Field_goal_ranking extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "field_goal_ranking_id,field_goal_ranking_year,field_goal_ranking_title,field_goal_ranking_state,field_goal_ranking_offers,field_goal_ranking_status";
	...
	{
        // $param['where']['kicker_ranking_year'] = $_POST['kicker_ranking_year'];
