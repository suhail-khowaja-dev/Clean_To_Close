...
class Punter_ranking extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "punter_ranking_id,punter_ranking_year,punter_ranking_title,punter_ranking_state,punter_ranking_offers,punter_ranking_status";
        $this->dt_params['searchable'] = array("punter_ranking_id","punter_ranking_title","punter_ranking_category","punter_ranking_latest_featured","punter_ranking_status");
	...
	{
        // $param['where']['punter_ranking_year'] = $_POST['punter_ranking_year'];
