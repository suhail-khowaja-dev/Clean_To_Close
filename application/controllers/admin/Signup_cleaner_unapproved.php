...
class Signup_cleaner_unapproved extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->dt_params['dt_headings'] = "signup_id, signup_name, signup_lastname,signup_email, signup_contact,signup_zip,signup_status_final_payment,signup_status";
        $this->dt_params['searchable'] = array("signup_id", "signup_type", "signup_name", "signup_lastname", "signup_zip","signup_status");
        $this->dt_params['action'] = array(
            ...
            "order_field" => false,
            "show_view" => false,
            "extra" => array('<a title="View" href="' . $config['admin_base_url'] . 'signup_cleaner_unapproved/detail?id=%d" class="btn-xs btn btn-primary cleaner_details_btn" target="_blank"><i class="icon-users"></i></a>'),
        );
    ...
    public function detail()
    {
        ...
        $paramsowner['joins'][] = array(
            "table" => "signup",
            "joint" => "signup.signup_id = user_team.user_team_user_id "
        );
        $paramsowner['where']['user_team_user_id'] = $_GET['id'];;
        $paramsowner['where']['user_team_status'] = 1;
        $paramsowner['where']['user_team_form_id'] = 0;
        $paramsowner['group'] = 'user_team_id';
        $data['team_owner'] = $this->model_user_team->find_one($paramsowner);
        ...
        public function update_cleaner_unapproved(){
                ...
                if (isset($_POST) and array_filled($_POST)) {
                    ...
                    $this->model_email->signup_email($_POST['cleaner']);
                }
