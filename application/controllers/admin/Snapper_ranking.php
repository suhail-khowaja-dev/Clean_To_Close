...
class Snapper_ranking extends MY_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
        $this->dt_params['dt_headings'] = "snapper_ranking_id,snapper_ranking_year,snapper_ranking_title,snapper_ranking_state,snapper_ranking_offers,snapper_ranking_status";
        $this->dt_params['searchable'] = array("snapper_ranking_id","snapper_ranking_title","snapper_ranking_category","snapper_ranking_latest_featured","snapper_ranking_status");
