...
<h2>P3K Rated Kickoffs – <?php echo $kicker_detail['kicker_year_title']?></h2>
</div>
</div>
</div>
...
<div class="col-md-12 tableCol" style="padding: 0px">
    ...
    <div class="row" style="align-items: center;">
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="sorting">
                <span>Filter By:</span>
                <select class="form-select" id="sorting" attr-year="<?php echo $kicker_year_id?>" aria-label="Default select example">
