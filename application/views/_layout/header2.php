    ...
    <div class="main-header">
        <div class="container">
            <div class="row">
                ...
                <div class="mobilecontainer hidden-lg hidden-md"> <a href="<?php echo g('base_url'); ?>">
                    </a> <span class="pull-right" onclick="openNav()" style="font-size:30px;cursor:pointer">☰</span> </div>
