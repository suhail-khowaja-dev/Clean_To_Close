            ...
            <td class="container" style="display: block !important;clear: both !important;margin: 0 auto !important;max-width: 580px !important;">
                <table style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="width:50%;padding:10px;background-color: #eee;">
                            <p>
                                <?php echo $arrival_time_data['arrival_time_name'] ?> arrives at <b><?php echo $arrival_time_data['arrival_time_datetime'] ?></b> to <b><?php echo $arrival_time_data['arrival_time_address']?></b> for cleaning services
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="width:50%;padding:10px;background-color: #eee;">
                            <p>
                            Instruction:
                            <?php echo $arrival_time_data['arrival_time_message'] ?>
                            </p>
                        </td>
                    </tr>
