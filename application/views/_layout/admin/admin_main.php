                        ...
                        <div class="havbar-header">
                            ...
                            if(array_filled($logo)){?>
                                <a href="<?=$config['base_url']?>admin">
                                    <img src="<?=Links::img($logo[0]['logo_image_path'],$logo[0]['logo_image'])?>" alt="logo" class="main-tem-logo" style="position: absolute;margin-top: 6px;"/>
                                </a>
                                <?}
                                ?>
            ...
            <div class="main-content ">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div id="style_selector" class="hidden-xs">
                                ...
                                <div class="style-toggle close dnono"></div>
                            </div>
                            <!-- end: STYLE SELECTOR BOX -->

                            <ol class="breadcrumb dnono">
                ...
                <div class="footer clearfix">
                    <div class="footer-items">
                        ...
                        <span class="go-top dnono"><i class="clip-chevron-up"></i></span>
                    </div>
                </div>
                <!-- END FOOTER -->
