    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form">
        ...
        <form class="cmxform form-horizontal tasi-form" id="<?=(isset($form_id))?$form_id:'' ?>" method="POST" action="" enctype="multipart/form-data">
          ...
          <h3 class="form-section">Set Pakage Disclimar</h3>
            <div>
              <?foreach ($cleaner_pakage_disclimar as $syscon) { ?>
                <div class="form-group ">
                      <label class="control-label col-md-2 " for="con<?=$syscon['cleaner_pakage_disclimar_id']?>"> 
                          <?=humanize($syscon['cleaner_pakage_disclimar_variable'])?>
                      </label>
                      <div class="col-md-9">
                        <input  type="text" name="cleaner_pakage_disclimar_attr[<?=$syscon['cleaner_pakage_disclimar_id']?>]"  value="<?=$syscon['cleaner_pakage_disclimar_value']?>"  id="con<?=$syscon['cleaner_pakage_disclimar_id']?>" class="form-control"/>
                      </div>
                </div>
              <?}?>  
            </div>
