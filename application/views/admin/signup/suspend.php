...
<div class="tab-content">
    <div id="home" class="tab-pane fade for-shodow in active">
        <form action="<?= g('admin_base_url') ?>signup/suspend_cleaner" method="post" id="cleanerunaproved" class="footTop">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Suspended</h3>
                </div>
                <div class="col-lg-6 d-flex flex-column">
                    ...
                    <input type="text" name="cleanersuspended[signup_note]" value="<?php echo $signup_suspend_cleaner['signup_note'] ?>">
                </div>
                <div class="col-lg-6">
...
<script>
    $(document).ready(function() {
        ...
        $("#re_active").click(function() {
            ...
            var url = "<?= g('admin_base_url') ?>signup/re_active";
            $.ajax({
                url: url,
                type: "POST",
                data: data,
