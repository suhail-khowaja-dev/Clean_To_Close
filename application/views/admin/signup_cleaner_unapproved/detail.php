    ...
    <div id="home" class="tab-pane fade for-shodow in active">
      <div class="row">
        ...
        <div class="col-lg-6 d-flex flex-column">
          ...
          <input type="text" name="cleaner[signup_address]" value="<?php echo $signup_data_cleaner['signup_address'] ?>, <?php echo $signup_data_cleaner['signup_city']; ?>, <?php echo $signup_data_cleaner['signup_state'] ?>" class="address custom_address" readonly>
        </div>
        <div class="col-lg-6 d-flex flex-column">
        ...
        <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" aria-describedby="example_info">
          <thead>
            <tr>
              ...
              <!-- <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 120px;">Form Type</th> -->
              ...
              <!-- <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 80px;">BackgroundCheck Form</th> -->

            </tr>
          </thead>
          <tbody>
            <!-- <tr class="odd">
                            <td class="sorting_1"><input type="text" placeholder="01" value="<?php echo $team_owner['user_team_id'] ?>" readonly></td>
                            <td class="sorting_1"><input type="text" placeholder="01" value="Owner Form" readonly></td>      
                            <td><input type="text" value="<?php echo $team_owner['signup_name'] ?> <?php echo $team_owner['signup_lastname'] ?> " readonly></td>
                            <td><input type="text" value="<?php echo $team_owner['signup_contact'] ?>" readonly></td>
                            <td><input type="text"  value="<?php echo $team_owner['signup_email'] ?>" readonly></td>
                            <td class="for-center"><button type="button" class="form_info_owner" data-id="<?php echo  $team_owner['user_team_id'] ?>">View</button></td>
                        </tr> -->
            ...
            <?php foreach ($team_memeber as $key => $value) { ?>
              <tr class="odd">
                ...
                <!-- <td class="sorting_1"><input type="text" placeholder="01" value="Member Form" readonly></td> -->
                <td><input type="text" value="<?php echo $value['user_team_member_name'] ?>" readonly></td>
...
<!-- modal for view form -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#criminalownerModal" id="acceptanceowner" hidden>
  Launch demo modal
</button>
<!-- Modal -->
<div class="modal fade" id="criminalownerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <form id="saveCardForm">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="mBody">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="row">
                    <div class="col-lg-6">
                      <input type="text" class="team_member_name" placeholder="Name" name="user_team_member_name" value="<?php echo $team_owner['signup_name'] ?> <?php echo $team_owner['signup_lastname'] ?>" readonly>
                    </div>
                    <div class="col-lg-6">
                      <input type="text" class="team_signature" placeholder="Signature" name="user_team_signature" value="" readonly>
                    </div>
...
<script>
  ...
  $(document).ready(function() {
    $(".form_info_owner").click(function() {
      $('#acceptanceowner').trigger('click')
    })
    ...
    $("#SaveNEdit").click(function(e) {
      ...
      if (password.length < 8) {
        ...
        setTimeout(function() {
          ...
          //                 window.location.href = "http://localhost/cleantoclose_dev/admin/signup_cleaner_unapproved";
          //             } else {
...
<script>
  let mycari = document.getElementsByClassName('custom_address')
  // console.log(mycari);
  $('.custom_address').html(function() {
  ...
  // const lastWordd = $('.custom_address').val().slice(-1)
  //   // $(lastWordd).css('Color', 'red')
  //   $('.custom_address').val(lastWordd)
</script>