    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form">
        ...
        <form class="cmxform form-horizontal tasi-form" id="<?=(isset($form_id))?$form_id:'' ?>" method="POST" action="" enctype="multipart/form-data">
          ...
          <h3 class="form-section">Set Cleaner Percentage</h3>
            <div>
              <?foreach ($cleaner_percentage as $syscon) { ?>
                <div class="form-group ">
                      <label class="control-label col-md-2 " for="con<?=$syscon['cleaner_percentage_id']?>"> 
                          <?=humanize($syscon['cleaner_percentage_variable'])?>
                      </label>
                      <div class="col-md-9">
                        <input  type="text" name="cleaner_percentage_attr[<?=$syscon['cleaner_percentage_id']?>]"  value="<?=$syscon['cleaner_percentage_value']?>"  id="con<?=$syscon['cleaner_percentage_id']?>" class="form-control"/>
                      </div>
                </div>
              <?}?>  
            </div>
