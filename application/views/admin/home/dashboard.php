...
<div class="col_3">
    <div class="col-md-3 widget widget1">
        <div class="r3_counter_box">
            ...
            <div class="stats for-card-padding">
                <a href="https://dashboard.stripe.com/login" target="_blank">Go To Stripe Dashboard</a>
                <div class="grow">
                    <p>Stripe</p>
                </div>
            </div>
    ...
    <div class="col-md-3 widget widget1">
        <div class="r3_counter_box">
            ...
            <div class="stats for-card-padding">
                <a href="https://quickbooks.intuit.com/global/" target="_blank">Quickbooks Login</a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h6>Email</h6>
                                        <a href="https://mail.google.com/mail/u/0/" target="_blank">
                                            <?php echo $admin_email[0]['emails_value'] ?>
                                        </a>
                                        <a href="https://mail.google.com/mail/u/0/" target="_blank">
                                            <?php echo $admin_email[2]['emails_value'] ?>
                                        </a>
                                        <a href="https://mail.google.com/mail/u/0/" target="_blank">
                                            <?php echo $admin_email[4]['emails_value'] ?>
                                        </a>
                                        <a href="https://mail.google.com/mail/u/0/" target="_blank">
                                            <?php echo $admin_email[6]['emails_value'] ?>
                                        </a>
                                        <a href="https://mail.google.com/mail/u/0/" target="_blank">
                                            <?php echo $admin_email[8]['emails_value'] ?>
                                        </a>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="countList">
                                        <h6>Unread</h6>
                                        <p><?php echo $rescheduleclean ??  0 ?></p>
                                        <p><?php echo $rescheduleclean ??  0 ?></p>
                                        <p><?php echo $rescheduleclean ??  0 ?></p>
                                        <p><?php echo $rescheduleclean ??  0 ?></p>
                                        <p><?php echo $adminclean ??  0 ?></p>
                                    </div>
                                    </div>
                                </div>
                        </div>
    ...
    $(function() {
        ...
        var revenueColumnChart = new CanvasJS.Chart("revenue-column-chart", {
            ...
            data: [{
                ...
                yValueFormatString: "###,###.##",
                dataPoints: [{
                        x: new Date('Jan <?php echo $year; ?>'),
                        y: <?php echo $jan; ?>
                    },
                    {
                        x: new Date('Feb <?php echo $year; ?>'),
                        y: <?php echo $feb; ?>
                    },
                    {
                        x: new Date('Mar <?php echo $year; ?>'),
                        y: <?php echo $mar; ?>
                    },
                    {
                        x: new Date('Apr <?php echo $year; ?>'),
                        y: <?php echo $apr; ?>
                    },
                    {
                        x: new Date('May <?php echo $year; ?>'),
                        y: <?php echo $may; ?>
                    },
                    {
                        x: new Date('Jun <?php echo $year; ?>'),
                        y: <?php echo $jun; ?>
                    },
                    {
                        x: new Date('Jul <?php echo $year; ?>'),
                        y: <?php echo $jul; ?>
                    },
                    {
                        x: new Date('Aug <?php echo $year; ?>'),
                        y: <?php echo $aug; ?>
                    },
                    {
                        x: new Date('Sep <?php echo $year; ?>'),
                        y: <?php echo $sep; ?>
                    },
                    {
                        x: new Date('Oct <?php echo $year; ?>'),
                        y: <?php echo $oct; ?>
                    },
                    {
                        x: new Date('Nov <?php echo $year; ?>'),
                        y: <?php echo $nov; ?>
                    },
                    {
                        x: new Date('Dec <?php echo $year; ?>'),
                        y: <?php echo $dec; ?>
                    }
                ]
            }]
