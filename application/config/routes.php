...
$route['how-we-vet'] = 'howwevet';
$route['camp-concept'] = 'about_us';
$route['why-clean-to-close'] = 'why';
$route['evaluation-team'] = 'team';
$route['long-snapper'] = 'snapper';
$route['field-goals'] = 'field_goal';
$route['user-login'] = 'user';
$route['location'] = 'map';
$route['terms-condition'] = 'terms_and_conditions';
$route['privacy-policy'] = 'privacy_policy';
$route['franchise-with-us'] = 'franchise_with_us';
$route['place-order'] = 'account/place_order';
$route['lets-get-to-know'] = 'user/cleaner_index';
// $route['place-order'] = 'account/place_order';
// $route['information-page'] = 'information_page';

$route['information-page'] = 'user/backgroundcheck';
$route['member-checkout'] = 'user/memebr_amount_pay';
...
$route['webhook-test'] = 'user/webhookListener';
